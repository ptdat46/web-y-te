    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <Link to="/app/chatbot" className="rounded-2xl border border-teal-100 bg-white p-6 transition hover:-translate-y-1 hover:border-teal-300 hover:shadow-lg">
          <div className="mb-4 text-3xl">🤖</div>
          <h2 className="font-semibold text-teal-950">{isDoctor ? 'Trợ lý bệnh án AI' : 'Chat với chatbot'}</h2>
          <p className="mt-2 text-sm text-teal-600">
            {isDoctor ? 'Chọn một bệnh nhân đã liên kết để trao đổi về dữ liệu sức khỏe.' : 'Đặt câu hỏi sức khỏe và nhận phản hồi hỗ trợ nhanh chóng.'}
          </p>
        </Link>
      </div>
    </div>
